...
public class Icon2RecyclerAdapter extends RecyclerView.Adapter<Icon2RecyclerAdapter.IconViewHolder> {
    ...
    public Icon2RecyclerAdapter(Context context, int[] iconResIds, String[] titles) {
